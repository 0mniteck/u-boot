...
cd ..
apt remove --purge acpica-tools adb autoconf automake bc binfmt-support bison build-essential ccache coccinelle cscope debootstrap device-tree-compiler dfu-util dosfstools e2tools efitools expect fakeroot fastboot flex gcc gcc-aarch64-linux-gnu gcc-arm-linux-gnueabihf gcc-arm-none-eabi graphviz imagemagick libattr1-dev libcap-ng-dev libfdt-dev libftdi-dev libglib2.0-dev libgmp3-dev libgnutls28-dev libguestfs-tools libhidapi-dev liblz4-tool libmbedtls-dev libmpc-dev libncurses-dev libpixman-1-dev libpython3-dev libsdl2-dev libslirp-dev libssl-dev libtool libusb-1.0-0-dev lz4 lzma lzma-alone make mtools netcat ninja-build parted pkg-config python2 python3-asteval python3-coverage python3-cryptography python3-dev python3-filelock python3-pip python3-pycryptodome python3-pytest python3-pyelftools python3-pytest-xdist python3-setuptools python3-sphinx-rtd-theme python3-sphinxcontrib.apidoc python3-subunit python3-testtools python3-virtualenv python-is-python3 rsync swig u-boot-tools uuid-dev uuid-runtime xdg-utils xterm zlib1g-dev -y && apt autoremove -y
